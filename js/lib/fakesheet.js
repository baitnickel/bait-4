...
export class FakeSheet {
    ...
    parseSourceText() {
        ...
        let leadLines = []; /** lines above the first section */
            ...
            if (firstChar == FAKESHEET.tokenCharacter) {
                ...
                if (!currentSection) {
                    if (line.includes(this.placeholder)) {
                        ...
                        leadLines.push(line); /** save plain text lines until we're in the first section */
                }
                else if (!commentOnly) {
                    if (leadLines.length) {
                        for (let leadLine of leadLines)
                            currentSection.addLine(leadLine);
                        leadLines = [];
                    }
