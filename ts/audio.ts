...
export function render() {
	...
	if (Start >= PlaylistTracks.length) log(`"start=${Start}" exceeds highest track number (${PlaylistTracks.length - 1})`, true);
	else Media.RunPlaylists(MediaFolders, PlaylistTracks, MainAudioElement, Start);
}
