...
type InstrumentProperties = { strings: number; frets: number; tuning: number[]; tuneDown: number; tuneUp: number};
...
export class Instrument {
	...
	openStringValues: number[]; /* MIDI values of the instrument's open strings */
